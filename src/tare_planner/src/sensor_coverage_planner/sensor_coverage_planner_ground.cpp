...
bool PlannerParameters::ReadParameters(ros::NodeHandle& nh)
{
  ...
  pub_waypoint_topic_ = misc_utils_ns::getParam<std::string>(nh, "pub_waypoint_topic_", "/tare_way_point");
...
//Callback to set covered subspaces by other ugv to covered for this ugv, by keith & jerome
...
//Callback to set exploring subspaces by other ugv to exploring for this ugv, by keith & jerome
